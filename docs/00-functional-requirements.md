...
| ~~**REQ-19**~~ | ~~Owner portal~~ | **Withdrawn.** The system is staff-only (ADR-007). Owner statements are produced by the office via `OwnerStatementService`, not by an owner logging in. |
...
| ~~**ADV-09**~~ | ~~Client portal~~ — **withdrawn**; customers are served at the counter |
